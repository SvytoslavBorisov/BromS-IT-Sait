...
/** --- Орбиты: всегда один и тот же wrapper; компонент монтируем только при heavyOK, ssr:false --- */
const OrbitRingsMaybe = dynamic(() => import("@/components/OrbitRings"), { ssr: false, loading: () => null });
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* 5) Стрелка вниз — только при heavyOK */}
      {heavyOK && !prefersReduced && (
